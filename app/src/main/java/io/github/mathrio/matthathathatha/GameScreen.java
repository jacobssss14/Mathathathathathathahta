...
public class GameScreen extends AppCompatActivity {
    ...
    Button btP, btE, bt0, btD, bt1, bt2, bt3, bt4, bt5, bt6, bt7, bt8, bt9, btSlash, btDot;
    EditText input1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btDot = (Button) findViewById(R.id.button7);
        btDot.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                input1.setText(input1.getText().insert(input1.getText().length(), "."));
            }
        });

        btSlash = (Button) findViewById(R.id.button13);
        btSlash.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                input1.setText(input1.getText().insert(input1.getText().length(), "/"));
            }
